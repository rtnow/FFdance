        ...
        if use_state:
            ...
            if two_cam:
                env = CameraViewWrapper(
                    env, num_frames=frame_stack, cam_id='track_cam', height=img_size, width=img_size,
                    depth=use_depth)
        else:
            env = CameraViewWrapper(
                env, num_frames=frame_stack, cam_id=camera_id, height=img_size, width=img_size, depth=use_depth)
            if two_cam:
                env = CameraViewWrapper(
                    ...
                    depth=use_depth)
            env = CameraViewWrapper(
                env, num_frames=frame_stack, cam_id='first_person_cam', height=img_size, width=img_size,
                depth=use_depth)
